...
# -*- coding: utf-8 -*-
"""
CNN+RNN for Recursive Signal Prediction
...
plt.plot(range(window_size + split, window_size + split + prediction), pred, 
         label='Recursive CNN+RNN Prediction', color='blue', linewidth=2)
plt.xlabel('Time Step', fontsize=14)
plt.ylabel('Amplitude', fontsize=14)
plt.title('Recursive CNN+RNN Prediction of Noisy Sine Wave', fontsize=15, fontweight='bold')
